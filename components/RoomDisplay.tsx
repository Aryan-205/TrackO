...
// Assuming your Room type is defined elsewhere or you can define it here
// type Room = {
//   // ... properties of your room model
//   slug: string;
//   // ...
// };
...
export default function RoomDisplay({ room }: { room: any }) { // Replace `any` with the actual Room type
